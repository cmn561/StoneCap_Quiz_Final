 ...
 */
public class NicknameLeaderboard extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstancenickname) {
        ...
        View view = inflater.inflate(R.layout.nickname_leaderboard_frag, container, false);
        l = (LinearLayout) view.findViewById(R.id.nicknameLinearScroll);
    ...
    public void loadLeaderboard() {
        ...
        rows = db.numRowsNickname();

        for (int i = 0; i <= rows - 1; i++) {
            Player playerToAdd;
            playerToAdd = db.getRowProductDataNickname(i);
