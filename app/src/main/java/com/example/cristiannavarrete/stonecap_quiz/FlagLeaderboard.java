 ...
 */
public class FlagLeaderboard extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstancenickname) {
        ...
        View view = inflater.inflate(R.layout.flag_leaderboard_frag, container, false);
        l = (LinearLayout) view.findViewById(R.id.flagLinearScroll);
    ...
    public void loadLeaderboard() {
        ...
        for (int i = 0; i <= rows - 1; i++) {
            Player playerToAdd;
            playerToAdd = db.getRowProductDataFlag(i);
