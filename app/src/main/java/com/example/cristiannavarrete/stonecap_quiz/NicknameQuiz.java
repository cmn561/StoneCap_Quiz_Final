 ...
 */
public class NicknameQuiz extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.nickname_quiz);
...
//        OutlineFrag frag = (OutlineFrag) getFragmentManager().findFragmentById(R.id.outlineFrag);
        ...
        Fragment frag = new NicknameFrag();
        FragmentManager fragmentManager = getSupportFragmentManager();
        android.support.v4.app.FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
        fragmentTransaction.add(R.id.nicknameFrag, frag);
    ...
    public void onBackPressed() {
        getSupportFragmentManager().findFragmentById(R.id.nicknameFrag).onDestroy();
    }
